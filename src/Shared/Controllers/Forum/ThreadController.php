<?php
namespace Shared\Http\Controllers\Forum;

use Penoaks\Http\Request;
use Penoaks\Http\RedirectResponse;
use Penoaks\Support\Facades\Gate;
use Events\Forum\UserCreatingThread;
use Events\Forum\UserMarkingNew;
use Events\Forum\UserViewingNew;
use Events\Forum\UserViewingThread;
